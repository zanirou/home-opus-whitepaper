...
| File | Description |
|------|-------------|
| `Home_Opus_White_Paper_v2.1-1.pdf` | The complete white paper (20 pages) |
| `build_v21-1.py` | Python source (ReportLab) that generates the PDF |
...
This work is licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) — you may share and adapt with attribution.
